# Genre, Titel, Releasejahr, Länge in Minuten
...
# movie_4.title= "Back to the Future"
# print(f"Titel des Filmes: {movie_4.title}")

# movie_4.genre = "Action"
# movie_4.duration= 110
# movie_4.release_year = 1985

movie_6 = Movie(title= "Dune: Awakening", genre="Schi-Fi", duration=180, release_year=2020)

print(f"Titel des Filmes 6: {movie_6.title}")
