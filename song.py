...
class Song:
    ...
    def zeige_info(self):
        print(f"Titel {self.titel}, Interpreten {self.interpreten} wurde erstellt!")  
...
print(nr_artists)
print(song_1.anzahl_interpreten()) #Das gleiche wie oben, nur wird das Ergebnis nicht zwischengespeichert
